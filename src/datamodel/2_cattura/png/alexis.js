export default {
  ...
  frase: `
    ...
    **cornice**
    ...
    Stai per chiederle spiegazioni, quando improvvisamente vedi Alexis aprire gli occhi; incredibilmente ha un aspetto più rilassato e inspira profondamente, come se la malattia fosse scomparsa.

    La trasformazione però dura solo pochissimi istanti, infatti Alexis batte le palpebre e ritorna ad accasciarsi su di un fianco...
