export default {
  ...
  frase: `
    ...
    La struttura è un semplice parallelepipedo, alto circa un metro e mezzo e profondo tre metri, con una porta, forse marcia, chiusa da un'asse di legno.
  `,

  audio: {
    src: "/assets/audio/impronteStivali.mp3",
  },
  risposte: [
    {
      frase: "Vuoi avvicinarti lateralmente nascondendoti tra le rocce",
      gioco: "dice",
    },
    {
      frase: "Vuoi avvicinarti sull'altro lato per sbirciare dalla finestra",
      gioco: "text",
    },
  ...
  text: {
    ...
    durata: "15",
    domande: ["Le tracce erano di ?", "Come ti chiami ?"],
    risposte: [
