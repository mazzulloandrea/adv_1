export default {
  ...
  "frase": `
    ...
    Lui si rialza e ti dice che si chiamata Giakkos; è un eremita e vive da solo nei colli sparsi.
    ...
    Giakkos ti saluta augurandoti buona fortuna e spera che in futuro potrai divenire più sincero.

    Ripensando alle parole dell'eremita, ti avvicini alle guardie attirando la loro attenzione.
    I soldati rimangono stupite della tua presenza.
    
    Convinti che sei tornato perchè avevi troppa paura di queste terre selvagge, ti legano le mani e ti mettono sul carretto insieme agli altri.
