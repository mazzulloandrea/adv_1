export default {
  ...
  frase: `
    ...
    Lui si chiamata Giakkos, ed è un eremita che vive da solo sui "colli sparsi".
    ...
    Per nulla convinto, vieni accompagnato dall'eremita che pare conoscere benissimo quelle terre.
    **cornice**
    ...
    Poi poggia le mani sul tuo petto e senti un beneficio molto piacevole, e con leggerezza ti allontani.
    ...
    **cornice**
    ...
    Tua sorella e gli altri ragazzi ti guardano con aria interrogativa e, se avrai modo e tempo, forse racconterai loro della tua conoscenza.

    Ora il viaggio prosegue.
  `,

  audio: {
    src: "/assets/audio/verita.mp3",
  },
  risposte: [
    {
      frase: "Corpo",
