...
export default {
  ...
  titolo: "La grotta",
  frase: `
    Sentendo queste parole, vai verso tuo fratello che ti abbraccia forte e stringendoti il braccio ti sussurra <<Non scapperai dall'addestramento>>.
  ...
  `,
  audio: {
    src: "/assets/audio/avviciniADenred.mp3",
  },
