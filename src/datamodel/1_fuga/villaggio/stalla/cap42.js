export default {
  ...
  frase: `
    ...
    Immediatamente attirano l'attenzione dei soldati e, mentre provi a scappare verso il bosco, ti si para davanti tuo fratellastro Denred che ti afferra per il vestito "Eccolo è qui"
  ...
  audio: {
    src: "/assets/audio/cap42.mp3", // TODO da integrare voce Carcadena
  },
  risposte: [
    {
