export default {
  ...
  frase: `
    ...
    Il tuo sguardo preoccupato comunica qualcosa a Carcadena che, probabilmente, non ha pienamente inteso.
    Rifletti velocemente: avvisarla usando il potere oppure fare finta di nulla?
  `,

  audio: {
    src: "/assets/audio/rinunciaSfida.mp3",
  },
  risposte: [
    { frase: "Vuoi avvisare Carcadena", next: "avvisareCarcadena3Prova" },
    {
      frase: "Meglio rispettare le regole del generale e stare zitti",
      next: "aspettareIlPotere",
    },
  ],
};
