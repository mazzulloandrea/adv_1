export default {
  ...
  frase: `
    ...
    Durante il secondo tentativo senti bruciare leggermente il ginocchio destro e durante il terzo il bruciore aumenta; vedi anche un piccolissimo scintillio di luce provenire dalla pietra sulla sommita del bastone, che però scompare subito, così come il dolore alla gamba.
  ...
  **cornice**
    ...
    Capisci immediatamente che si tratta della tua terza prova.
  `,

  audio: {
    src: "/assets/audio/scettro.mp3",
  },
  risposte: [
    { frase: "Cosa devo aspettarmi li sotto?", next: "rispostaCuriosa" },
    {
      frase: "Non è meglio anche una seconda torcia?",
      gioco: "dice",
      zaino: "torcia",
    },
