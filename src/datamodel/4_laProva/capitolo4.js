export default {
  ...
  frase: `
    ...
    **cornice**
    ...
    Passano due giorni e credi che qualcuno abbia già effettuato la "prova"; vedi Frozia più cupo del solito e Alexis, che oramai si è ripreso completamente dalla malattia, cerca sempre di schivarti.
    Sei sospettoso anche di qualcun altro quando, il giorno dopo, ti si avvicina una guardia; ti avverte che Ravon attende nella sua tenda.
    Con un po' di timore raggiungi la tenda del capitano.
  `,

  audio: {
    src: "/assets/audio/capitolo4.mp3",
  },
  risposte: [
    {
