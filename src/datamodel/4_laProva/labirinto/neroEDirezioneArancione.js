export default {
  ...
  frase: `
    ...
    **cornice**
    Giungi ad un incrocio a quattro vie: a destra, una rientanza con una porta metallica che chiude il passaggio, avanti, oltre l'incrocio, un passaggio di colore arancione acceso, a sinistra, un corridio colorato di viola, alle tue spalle, il corridio scuro.
    
  `,

  audio: {
    src: "/assets/audio/neroEDirezioneArancione.mp3",
  },
  risposte: [
