export default {
  ...
  frase: `
    ...
    Avanti una rientanza con una porta metallica che chiude il passaggio, ad sinistra un corridodio arancione, a destra una via nera.
  `,

  audio: {
    src: "/assets/audio/violaS.mp3",
  },
  risposte: [
