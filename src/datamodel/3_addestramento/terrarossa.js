export default {
  "titolo": "Terrarossa",
  "frase": `
    Dopo un paio d'ore di fuori pista arrivate in uno spiazzo di terra battuta rossastra, ad aspettarvi ci sono una decina di soldati e altri 4 giovani come voi.

    Tutto il perimetro è definito con pali di legno e fil di ferro ed una volta entrati capisci che sarà impossibile scappare da questo luogo definito come "campo d'addestramento".
