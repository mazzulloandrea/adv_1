export default {
  ...
  frase: `
    ...
    **cornice**
    ...
    Cavalcare, sopportare il dolore, il caldo, il freddo, riconoscere un pericolo, saper usare un'arma, ...affrontare un avversario...
    ...
    **cornice**
    ...
    Anche il vino termina in pochi istanti ed, immediatamente, ve ne viene versato un secondo bicchiere, intimandovi di berlo molto rapidamente.

    Senza farvi troppe domande finite il bicchierone, dopodichè il comandante, inaspettatamente, da inizio alla "prima prova".
  `,
  audio: {
    src: "/assets/audio/terrarossa.mp3",
  },
  gioco: "text",
  text: {
    successo: "primaProva",
