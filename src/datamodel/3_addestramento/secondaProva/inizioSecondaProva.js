export default {
  ...
  frase: `
    ...
    **cornice**
    Un grosso lucchetto a combinazione è davanti a te; tutt'attorno un muro di legno alto più di 2 metri impedisce di vedere l'interno.
    
    La guardia da l'ordine: la tua seconda prova è iniziata.
  `,

  audio: {
    src: "/assets/audio/inizioSecondaProva.mp3",
  },
  risposte: [
