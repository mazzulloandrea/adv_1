export default {
  ...
  "frase": `
    ...
    Alexis senza esitare afferma di voler imparare l'arte dell'attacco a distanza e senza aspettare la tua approvazione
    convince la guardia che gli mostra i diversi tipi di armi: un arco, una balestra ed una fionda.
