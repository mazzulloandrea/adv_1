export default {
  ...
  frase: `
    ...
    **cornice**
    ...
    Lo scontro avrà una durata di mezz'ora massimo e avverrà in una zona adiacente al campo di addestramento; ci saranno alberi, nascondigli, trappole e ripari.
    
    Non è stato specificato cosa potrebbe accadere ma avete capito, dai toni del generale, che non ci sono regole.
    **cornice**
  ...
  audio: {
    src: "/assets/audio/addestramento.mp3",
  },
  risposte: [
