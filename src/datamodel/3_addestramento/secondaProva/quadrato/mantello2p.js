export default {
  ...
  frase: `
    ...
    Ascolti in un silenzio assoluto i movimenti del tuo nemico che lentamente si avvicinano; raccogli un sasso da terra e sei pronto a colpire il tuo nemico appena sarà a pochissimi passi da te.
