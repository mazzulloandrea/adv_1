export default {
  ...
  frase: `
    ...
    Stai per rialzarti per spingerla via quando ti accorgi di essere finito ad un piede dal bordo; nemmeno il tempo di spostarti che un avversario dai capelli rossi, più basso di te ma più muscoloso, ti piomba addosso con tutta l'intenzione di spingerti fuori.
